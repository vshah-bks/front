...
var MenuDivider = /** @class */ (function (_super) {
    ...
    MenuDivider.prototype.render = function () {
        ...
        if (title == null) {
            // simple divider
            return React.createElement("li", { className: (0, classnames_1.default)(Classes.MENU_DIVIDER, className), role: "none" });
        }
        else {
            // section header with title
            return (React.createElement("li", { className: (0, classnames_1.default)(Classes.MENU_HEADER, className), role: "none" },
                React.createElement(html_1.H6, null, title)));
        }
    };
    MenuDivider.displayName = "".concat(props_1.DISPLAYNAME_PREFIX, ".MenuDivider");
    return MenuDivider;
}(React.Component));
