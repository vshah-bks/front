...
var Icon = /** @class */ (function (_super) {
    ...
    Icon.prototype.render = function () {
        ...
        var titleId = (0, utils_1.uniqueId)("iconTitle");
        return React.createElement(tagName, tslib_1.__assign(tslib_1.__assign({}, htmlprops), { "aria-hidden": title ? undefined : true, className: classes, title: htmlTitle }), React.createElement("svg", { fill: color, "data-icon": icon, width: size, height: size, viewBox: viewBox, "aria-labelledby": title ? titleId : undefined, role: "img" },
