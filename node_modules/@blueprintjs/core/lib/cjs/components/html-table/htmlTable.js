...
var HTMLTable = /** @class */ (function (_super) {
    ...
    HTMLTable.prototype.render = function () {
        ...
        var _b = this.props, bordered = _b.bordered, className = _b.className, condensed = _b.condensed, elementRef = _b.elementRef, interactive = _b.interactive, striped = _b.striped, htmlProps = tslib_1.__rest(_b, ["bordered", "className", "condensed", "elementRef", "interactive", "striped"]);
