 ...
 */
export class Tag extends AbstractPureComponent2 {
    static displayName = `${DISPLAYNAME_PREFIX}.Tag`;
    render() {
        ...
        const removeButton = isRemovable ? (React.createElement("button", { "aria-label": "Remove Tag", type: "button", className: Classes.TAG_REMOVE, onClick: this.onRemoveClick, tabIndex: interactive ? tabIndex : undefined },
